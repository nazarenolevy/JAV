...
public class Flight implements Priceable {
	...
	public String toString() {
		return "Flight{" + "origin=" + origin.getIataCode() + ", destination=" + destination.getIataCode()
				+ ", airline='" + airline + '\'' + ", priceInUsd=" + priceInUsd + ", date="
				+ date.toString(DateTimeFormat.shortDateTime()) + '}';
	}
	...
	public boolean equals(Object o) {
		...
		if (airline != null ? !airline.equals(flight.airline) : flight.airline != null)
			return false;
		if (date != null ? !date.equals(flight.date) : flight.date != null)
			return false;
